...
class HardeningTests(unittest.TestCase):
    ...
    def test_bootstrap_scripts_provide_standalone_ai_install_path(self):
        ...
        self.assertIn('[string]$Ref = "v1.0.3"', bootstrap_ps)
        ...
        self.assertIn('REF="v1.0.3"', bootstrap_sh)
    ...
    def test_readme_documents_packaged_install_and_pexo_mcp(self):
        ...
        self.assertIn('uv tool install "git+https://github.com/ParadoxGods/pexo-agent.git@v1.0.3"', readme)
        self.assertIn('pipx install "git+https://github.com/ParadoxGods/pexo-agent.git@v1.0.3"', readme)
    ...
    def test_agents_file_documents_safe_windows_install_path(self):
        ...
        self.assertIn('pipx install "git+https://github.com/ParadoxGods/pexo-agent.git@v1.0.3"', agents_doc)
